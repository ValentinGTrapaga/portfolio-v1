...
export const projects = [
  ...
  },
  {
    ...
    summary:
      'Created a SPA with ReactJS for a simulated e-commerce platform. Integrated data retrieval from an API and implemented a responsive shopping cart using the useContext hook. The Shopping Application is an e-commerce solution that features a Home Page with a collection of products and a Shopping Cart capability. The application uses Context Hook to maintain and update the shopping cart items dynamically, providing users with a smooth and seamless shopping experience'
  },
  {
    title: 'PokedexApp',
    stack: [
