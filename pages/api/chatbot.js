export default async function handler(req, res) {
  ...
  try {
    ...
    return res.status(200).json({ data: 'hello from the API' })
  } catch (error) {
    console.log(error)
